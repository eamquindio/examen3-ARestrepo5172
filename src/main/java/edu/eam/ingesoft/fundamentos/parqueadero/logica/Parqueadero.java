...
public class Parqueadero {
    ...
    public Propietario buscarPropietario(String cedula) {
        ...
        ArrayList<Propietario> propietarios = this.propietarios;
     ...
     * @return true si se registró exitosamente, false si la placa ya existe o el
    ...
    public boolean registrarVehiculo(String placa, int modelo, String color, String cedula, String tipo) {
        ...
        int modeloVehiculo = modelo;
        String colorVehiculo = color;
        String tipoVehiculo = tipo;
        Propietario propietarioVehiculo = buscarPropietario(cedula);
        if (buscarVehiculo(placa) == null && propietarioVehiculo != null) {
            Vehiculo nuevoVehiculo = new Vehiculo(placaVehiculo, modeloVehiculo, colorVehiculo, propietarioVehiculo, tipoVehiculo);
    ...
    public double calcularTotalRecaudado() {
        ...
        double total = 0;
        ArrayList<Servicio> servicios = this.servicios;
